  ...
  return (
    <>
      <div className="city-tour">
        <div>
          ...
          <p>
            ...
            with a photo to remember it by. Then, we find ourselves a calm part
            of the harbour to enjoy the jetskis themselves.
          </p>
          <p>
        ...
        <div>
          <img src="client/public/city.png" alt="City Tour Image" />
        </div>
      </div>
      <div className="harbour-tour">
        ...
        <div>
          <img src="client/public/harbour.png" alt="Harbour Tour Image" />
        </div>
      </div>
      <div className="waiheke-tour">
        ...
        <div>
          <img src="client/public/waiheke.png" alt="Waiheke Tour Image" />
        </div>
      </div>
      <div className="gulf-tour">
        <div>
          ...
          <p>
            ...
            around. Motuihe Island provides white sand beach backdrops with time
            for a swim & views out into the Pacific Ocean. Follow Rangitoto
            Island's 600 year old volcanic coastline riding past the iconic
            Rangitoto baches with a stop at the jaw-dropping Rangitoto Sand Bar
            for true, 360 degree views of Volcano Peaks & City Skyline. An
            action packed trip guaranteed to be good for the soul.
          </p>
          <p>
            <strong>Duration: 3.5 Hours</strong>
          </p>
      ...
      <div className="sunset-tour">
        <div>
          ...
          <p>
            ...
            & the city lights begin to wake. You will pilot your own jetskis
            across the face of downtown Auckland, beneath the Harbour Bridge &
            along the cliff top mansions of Herne Bay. We then regroup &
            experience the setting sun as it lowers in the west and shines back
            on the City Skyline.
          </p>
          <p>
